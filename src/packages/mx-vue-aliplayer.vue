...
<style>
@import url(http://g.alicdn.com/de/prismplayer/2.7.2/skins/default/aliplayer-min.css);
</style>
<script>
export default {
  name: "MxVueAliplayer",
  ...
  methods: {
    insertScript () {
      ...
      if (aliScript === null) {
        ...
        aliScript.src = "http://g.alicdn.com/de/prismplayer/2.7.2/aliplayer-min.js"
